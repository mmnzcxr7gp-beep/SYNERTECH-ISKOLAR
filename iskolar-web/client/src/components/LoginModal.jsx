      ...
      >
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-800">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">Please review and accept our Data Privacy terms before creating an account.</p>
          </div>
          <button
            onClick={onCancel}
        ...
        <div className="my-4 overflow-y-auto pr-2 space-y-4 text-xs text-slate-300 leading-relaxed max-h-[45vh] bg-slate-900/60 p-4 rounded-2xl border border-slate-800">
          <p className="font-bold text-white text-sm">SYNERTECH ISKOLAR PRIVACY POLICY</p>
          <p className="text-[11px] text-slate-400">Effective Date: August 2026</p>

          <div className="space-y-2">
            <h4 className="font-bold text-slate-200">1. Introduction & Compliance</h4>
            <p>
    ...
    <>
      ...
      >
        ...
        >
          ...
          {!mfaToken && regStep === 1 && (
            <div className="flex bg-slate-900/60 p-1 rounded-2xl mb-6 border border-slate-800">
              <button
                type="button"
              ...
              mode === 'login' ? (
                ...
                <div className="space-y-5 pt-2 text-center">
                  ...
                  <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800 text-left space-y-2 text-xs text-slate-300">
                    <div className="font-bold text-white mb-1">What happens next?</div>
